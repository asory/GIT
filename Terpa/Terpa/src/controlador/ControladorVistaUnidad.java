...
public class ControladorVistaUnidad implements ActionListener {
	...
	public void agregarUni() {
		...
		Unidad uni = new Unidad(vuni.getPlaca(), vuni.getIndiceComboTipo(),
				false, vuni.getSocio(), Integer.parseInt(vuni.getNumero()));

		if (vuni.getRif().isEmpty() || vuni.getNumero() == "0 "
				|| vuni.getSocio().equals("") || vuni.getPlaca().equals("")
